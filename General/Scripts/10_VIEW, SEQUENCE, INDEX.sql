...
-- 왜 사용할까?
--> VIEW를 이용해서 DML(INSET, UPDATE, DELETE) 하지 말라고
...
INSERT INTO TB_TEST 
VELUES(SEQ_TEST_NO.NEXTVAL, '짱구'); -- 125

INSERT INTO TB_TEST 
VELUES(SEQ_TEST_NO.NEXTVAL, '철수'); -- 130

INSERT INTO TB_TEST 
VELUES(SEQ_TEST_NO.NEXTVAL, '유리'); -- 135
...
WHERE TEST_NAME = '짱구';
--> 짱구의 TEST_NO 값을 150개까지 증가시키고나서
	--> 다시 한번 더 SQL_TEST_NO.NEXTVAL exceeds
...
-- SEQ_TEST_NO의 MAXVALUE 같을 200으로 수정
