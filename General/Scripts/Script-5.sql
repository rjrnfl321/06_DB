...
--
---- 계정 생성
--CREATE USER SPRING_KJW IDENTIFIED BY SPRING1234;
--
---- 권한 부여
--GRANT CONNECT, RESOURCE TO SPRING_KJW;
--
---- 테이블 저장 공간 할당
--ALTER USER SPRING_KJW
...
UPDATE "MEMBER"
SET
	"MEMBER_PW" = '$2a$10$ldrThbKfM.MBqubXgi0QpOwCPwMdNGmFblI35WVxBxmkBcho9AsjC'
WHERE
	"MEMBER_NO" = 1;
