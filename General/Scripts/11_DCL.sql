 ...
 * 
 * -> 객체를 다루거나 생성하는 권한이 하나도 없어서 할수 있는게 없음
 * 
...
REVOKE
 ...
 SELECT * FROM KH_KJW.EMPLOYEE; -- 조회 불가
